...
class ClusterCommandSpec {
  ...
  static const Map<String, CommandSpec> specs = {
    ...
    'PFDEBUG': CommandSpec.singleKeyAt(2),
    'PFSELFTEST': noKey,
    ...
    'TS.ADD': CommandSpec.singleKeyAt(1),
    'TS.ALTER': CommandSpec.singleKeyAt(1),
    'TS.CREATE': CommandSpec.singleKeyAt(1),
    'TS.CREATERULE': CommandSpec.twoKeysAt(1),
    'TS.DECRBY': CommandSpec.singleKeyAt(1),
    'TS.DEL': CommandSpec.singleKeyAt(1),
    'TS.DELETERULE': CommandSpec.twoKeysAt(1),
    'TS.GET': CommandSpec.singleKeyAt(1),
    'TS.INCRBY': CommandSpec.singleKeyAt(1),
    'TS.INFO': CommandSpec.singleKeyAt(1),
    'TS.MADD': CommandSpec.keysEveryNFrom(1, 3),
    'TS.MGET': noKey,
    'TS.MRANGE': noKey,
    'TS.MREVRANGE': noKey,
    'TS.QUERYINDEX': noKey,
    ...
    'VEMB': CommandSpec.singleKeyAt(1),
    'VGETATTR': CommandSpec.singleKeyAt(1),
    'VINFO': CommandSpec.singleKeyAt(1),
    'VISMEMBER': CommandSpec.singleKeyAt(1),
    'VLINKS': CommandSpec.singleKeyAt(1),
    'VRANDMEMBER': CommandSpec.singleKeyAt(1),
    'VRANGE': CommandSpec.singleKeyAt(1),
    'VREM': CommandSpec.singleKeyAt(1),
    'VSETATTR': CommandSpec.singleKeyAt(1),
    'VSIM': CommandSpec.singleKeyAt(1),
